...
Thank you for your interest in contributing to freee-demo-kit! This document provides guidelines and
instructions for contributing to the project.

## 🙏 Welcome!

freee-demo-kit is a CLI tool for managing Zoom meetings via Server-to-Server OAuth. We welcome
...
- ✨ **Adding new features** - Expand freee-demo-kit's capabilities (discuss first!)
...
- 💬 **Questions** - Open a [GitHub Discussion](https://github.com/tackeyy/freee-demo-kit/discussions)
- 🐛 **Bug Reports** - Open an [Issue](https://github.com/tackeyy/freee-demo-kit/issues/new?template=bug_report.yml)
- 💡 **Feature Requests** - Open an [Issue](https://github.com/tackeyy/freee-demo-kit/issues/new?template=feature_request.yml)
- ❓ **General Questions** - Open an [Issue](https://github.com/tackeyy/freee-demo-kit/issues/new?template=question.yml)
...
Thank you for contributing to freee-demo-kit! Your efforts help make this tool better for everyone.
