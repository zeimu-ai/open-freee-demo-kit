...
- 0.1.8 時点で **領収書/証憑ファイルのアップロード** に対応
...
◆ Client Secret を入力してください
  ...
  ┌─ Step 3/3  プリセット選択 ──────────────────────┐
  ❯ accounting/office-demo — 会計+経費の統合版・初回体験向け（証憑3件・固定資産入り）
...
| `accounting/full-year` | 架空ITサービス業・12ヶ月分・異常値パターン付き | 3 | 101 | 13 |
...
| `accounting/cross-border-saas` | 架空B2B SaaS企業・輸出売上・USD外貨預金・海外クラウド費用・海外広告費・前受収益・為替差損益 | 3 | 25 | 7 |
...
| `TAX-CODE-001` | 勘定科目ごとの許容税区分と不一致（売上高: 21/13/22、外注費: 34/18 等） | ERROR |
